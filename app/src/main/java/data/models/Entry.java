...
public class Entry extends RealmObject implements Parcelable {
    ...
    public String getID() { return idUrl.substring(21);}
    ...
    public Boolean getIsInReadList() { return isInReadList; }
    public void setIsInReadList(Boolean isInReadList) { this.isInReadList = isInReadList; }
    ...
    @Override public void writeToParcel(Parcel dest, int flags) {
        ...
        if (this.isDownloaded) dest.writeInt(1);
        else dest.writeInt(0);
        if (this.isInReadList) dest.writeInt(1);
        else dest.writeInt(0);
    }
    ...
    protected Entry(Parcel in) {
        ...
        this.isDownloaded = (in.readInt() == 1);
        this.isInReadList = (in.readInt() == 1);
    }

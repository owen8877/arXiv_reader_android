...
public class RealmUtil {
    ...
    public static boolean firstRunPopulateDatabase() {
        ...
        try {
            ...
            final Category csMachineLearning = realm.copyToRealm(new Category("LG", "Machine Learning"));
            ...
            final Category neuralEvoComp = realm.copyToRealm(new Category("NE", "Neural and Evolutionary Computing"));
            ...
            final Category audioSpeechProcessing = realm.copyToRealm(new Category("AS", "Audio and Speech Processing"));
            final Category imageVideoProcessing = realm.copyToRealm(new Category("IV", "Image and Video Processing"));
            final Category signalProcessing = realm.copyToRealm(new Category("SP", "Signal Processing"));

            RealmList<Category> eessCategories = new RealmList<>(allTopics,audioSpeechProcessing,imageVideoProcessing, signalProcessing);
            ...
            realm.copyToRealm(new Subject("eess", "Electrical Engineering and Systems Science", eessCategories));
